...
class TahunAkademikController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'tahun_ajaran' => 'required|string|unique:tahun_akademik,tahun_ajaran,NULL,id,sekolah_id,' . $request->sekolah_id,
    ...
    {
        $validator = Validator::make($request->all(), [
            'tahun_ajaran' => 'sometimes|string|unique:tahun_akademik,tahun_ajaran,' . $tahunAkademik->id . ',id,sekolah_id,' . $tahunAkademik->sekolah_id,

          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">
                Kelola data siswa Sekolah Menengah Pertama
              </p>
            </div>
            <button
...
import { useSiswaSMPStore } from '@/stores/jenjang/smp/siswaSMP'
// import.*@/components/jenjang/smp/CreateStudentSMPModal.vue'
// import.*@/components/jenjang/smp/EditStudentSMPModal.vue'
// import.*@/components/jenjang/smp/ViewStudentSMPModal.vue'
// import.*@/components/jenjang/smp/ImportStudentsSMPModal.vue'

// 
const siswaSMP = useSiswaSMPStore()
...
const loadStudents = async () => {
  ...
  try {
    const response = await siswaSMP.getAll({
...
const loadStatistics = async () => {
  try {
    statistics.value = await siswaSMP.getStatistics()
  } catch (error) {
...
const deleteStudent = async (student) => {
  if (confirm(`Apakah Anda yakin ingin menghapus siswa ${student.nama_lengkap}?`)) {
    try {
      await siswaSMP.delete(student.id)
      await loadStudents()

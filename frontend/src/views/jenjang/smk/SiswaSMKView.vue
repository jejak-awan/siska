          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">
                Kelola data siswa Sekolah Menengah Kejuruan
              </p>
            </div>
            <button
...
import { useSiswaSMKStore } from '@/stores/jenjang/smk/siswaSMK'
// import.*@/components/jenjang/smk/CreateStudentSMKModal.vue'
// import.*@/components/jenjang/smk/EditStudentSMKModal.vue'
// import.*@/components/jenjang/smk/ViewStudentSMKModal.vue'
// import.*@/components/jenjang/smk/ImportStudentsSMKModal.vue'

// 
const siswaSMK = useSiswaSMKStore()
...
const loadStudents = async () => {
  ...
  try {
    const response = await siswaSMK.getAll({
...
const loadStatistics = async () => {
  try {
    statistics.value = await siswaSMK.getStatistics()
  } catch (error) {
...
const deleteStudent = async (student) => {
  if (confirm(`Apakah Anda yakin ingin menghapus siswa ${student.nama_lengkap}?`)) {
    try {
      await siswaSMK.delete(student.id)
      await loadStudents()

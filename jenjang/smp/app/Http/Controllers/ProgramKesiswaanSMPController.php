...
use App\Jenjang\SMP\Services\ProgramKesiswaanSMPService;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;

class ProgramKesiswaanSMPController extends Controller
{
    protected $programService;

    public function __construct(ProgramKesiswaanSMPService $programService)
    {
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengambil data program kesiswaan SMP',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMP berhasil ditambahkan',
                'data' => $program
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal menambahkan program kesiswaan SMP',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function show(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Program kesiswaan SMP tidak ditemukan',
                'error' => $e->getMessage()
            ], 404);
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMP berhasil diperbarui',
                'data' => $program
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal memperbarui program kesiswaan SMP',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMP berhasil dihapus'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal menghapus program kesiswaan SMP',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    /**
     * Get statistics for SMP programs
     */
    public function statistics(): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengambil statistik program kesiswaan SMP',
                'error' => $e->getMessage()
            ], 500);
        }
    }

...
use App\Jenjang\SMK\Models\ProgramKesiswaanSMK;
use App\Jenjang\SMK\Models\ProgramPesertaSMK;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;

class ProgramKesiswaanSMKService
{
    protected $programModel;
    protected $pesertaModel;

    public function __construct(ProgramKesiswaanSMK $programModel, ProgramPesertaSMK $pesertaModel)
    {
    ...
    /**
     * Get all SMK programs with pagination and filters
     */
     ...
     * Get program by ID
     */
    public function getById(string $id): ProgramKesiswaanSMK
    {
     ...
     * Create new program
     */
    public function create(array $data): ProgramKesiswaanSMK
    {
     ...
     * Update program
     */
    public function update(string $id, array $data): ProgramKesiswaanSMK
    {
     ...
     */
    public function addParticipant(string $programId, array $data): ProgramPesertaSMK
    {

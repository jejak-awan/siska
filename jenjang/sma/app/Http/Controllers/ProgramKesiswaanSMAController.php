...
use App\Jenjang\SMA\Services\ProgramKesiswaanSMAService;
...
class ProgramKesiswaanSMAController extends Controller
{
    ...
    public function __construct(ProgramKesiswaanSMAService $programService)
    {
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengambil data program kesiswaan SMA',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMA berhasil ditambahkan',
                'data' => $program
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal menambahkan program kesiswaan SMA',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function show(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Program kesiswaan SMA tidak ditemukan',
                'error' => $e->getMessage()
            ], 404);
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMA berhasil diperbarui',
                'data' => $program
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal memperbarui program kesiswaan SMA',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Program kesiswaan SMA berhasil dihapus'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Gagal menghapus program kesiswaan SMA',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    /**
     * Get statistics for SMA programs
     */
    public function statistics(): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengambil statistik program kesiswaan SMA',
                'error' => $e->getMessage()
            ], 500);
        }
    }

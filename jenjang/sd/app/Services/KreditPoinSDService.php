...
class KreditPoinSDService
{
    ...
    {
        return KreditPoinSD::create($data);
    }

    /**
     * Update credit point
     */
    public function updateCreditPoint(KreditPoinSD $kreditPoin, array $data)
    {
     ...
     * Delete credit point
     */
    public function deleteCreditPoint(KreditPoinSD $kreditPoin)
    {
    ...
    {
        $query = KreditPoinSD::where('id_siswa', $idSiswa);

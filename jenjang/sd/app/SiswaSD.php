...
class SiswaSMA extends Model
{
    ...
    {
        return $this->belongsTo(UserSMA::class, 'id_user');
    }

    public function presensi(): HasMany
    {
        return $this->hasMany(PresensiSMA::class, 'id_siswa');
    }

    public function kreditPoin(): HasMany
    {
        return $this->hasMany(KreditPoinSMA::class, 'id_siswa');
    }

    public function penilaianKarakter(): HasMany
    {
        return $this->hasMany(PenilaianKarakterSMA::class, 'id_siswa');
    }

...
class SiswaSMAController extends Controller
{
     ...
     */
    public function show(SiswaSMA $siswa): JsonResponse
    {
        $siswa->load('user');
     ...
     */
    public function update(Request $request, SiswaSMA $siswa): JsonResponse
    {
        $request->validate([
     ...
     */
    public function destroy(SiswaSMA $siswa): JsonResponse
    {
        DB::connection('sd')->beginTransaction();

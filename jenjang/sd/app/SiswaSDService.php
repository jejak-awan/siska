...
use App\Jenjang\SMA\Models\UserSMA;
...
class SiswaSMAService
{
     ...
     * Update student
     */
    public function updateStudent(SiswaSMA $siswa, array $data)
    {
        DB::connection('sd')->beginTransaction();
     ...
     * Delete student
     */
    public function deleteStudent(SiswaSMA $siswa)
    {
        DB::connection('sd')->beginTransaction();
    ...
    {
        return [
            'total_siswa' => SiswaSMA::count(),
            'siswa_aktif' => SiswaSMA::where('status', 'active')->count(),
            'siswa_per_kelas' => SiswaSMA::selectRaw('kelas, COUNT(*) as jumlah')
                ->where('status', 'active')
                ->groupBy('kelas')
                ->get(),
            'siswa_per_jenis_kelamin' => SiswaSMA::selectRaw('jenis_kelamin, COUNT(*) as jumlah')
                ->where('status', 'active')
     ...
     */
    public function getAttendanceSummary(SiswaSMA $siswa, $semester = null, $tahunAkademik = null)
    {
     ...
     */
    public function getCreditPointsSummary(SiswaSMA $siswa, $semester = null, $tahunAkademik = null)
    {

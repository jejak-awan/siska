...
class ProgramKesiswaanSD extends Model
{
    ...
    {
        return $this->belongsTo(UserSD::class, 'penanggung_jawab_id');
    }

    public function penilaianKarakter(): HasMany
    {
        return $this->hasMany(PenilaianKarakterSD::class, 'id_program_kesiswaan');
    }

...
class KreditPoinSMAController extends Controller
{
    /**
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $kreditPoin = KreditPoinSMA::create($request->all());
     ...
     */
    public function show(KreditPoinSMA $kreditPoin): JsonResponse
    {
     ...
     */
    public function update(Request $request, KreditPoinSMA $kreditPoin): JsonResponse
    {
        $request->validate([
     ...
     */
    public function destroy(KreditPoinSMA $kreditPoin): JsonResponse
    {
        $kreditPoin->delete();

...
class ProgramKesiswaanSDController extends Controller
{
    /**
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $program = ProgramKesiswaanSD::create($request->all());
     ...
     */
    public function show(ProgramKesiswaanSD $program): JsonResponse
    {
     ...
     */
    public function update(Request $request, ProgramKesiswaanSD $program): JsonResponse
    {
        $request->validate([
     ...
     */
    public function destroy(ProgramKesiswaanSD $program): JsonResponse
    {
     ...
     */
    public function getParticipants(ProgramKesiswaanSD $program): JsonResponse
    {

...
class PresensiSDController extends Controller
{
    /**
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $existingPresensi = PresensiSD::where('id_siswa', $request->id_siswa)
        ...
        $presensi = PresensiSD::create($request->all());
     ...
     */
    public function show(PresensiSD $presensi): JsonResponse
    {
     ...
     */
    public function update(Request $request, PresensiSD $presensi): JsonResponse
    {
        $request->validate([
            'jam_masuk' => 'nullable|date_format:H:i',
            'jam_keluar' => 'nullable|date_format:H:i',
     ...
     */
    public function destroy(PresensiSD $presensi): JsonResponse
    {
        $presensi->delete();
